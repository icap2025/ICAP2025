  ...
  <defs>
    ...
    >
      ...
      <stop offset="1" stopOpacity="0" />
                ...
                <Link
                  href="/"
                  className="px-8 py-3 text-base font-bold text-black border-4 duration-300 rounded-md bg-white shadow-signUp border-primary hover:text-white hover:bg-primary md:px-9 lg:px-8 xl:px-9"
                >
                  Back to Homepage
                </Link>
              </div>
